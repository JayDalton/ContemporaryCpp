...
// 	if (av_find_best_stream(File, AVMEDIA_TYPE_VIDEO, DetectStream, -1, &pCodec, 0) != FirstStream 
//       or pCodec == nullptr or pCodec->id != AV_CODEC_ID_GIF)
// 		File = {};
...
// auto decodeFrames(libav::File File, libav::Codec Decoder) -> std::generator<video::Frame> 
// {
